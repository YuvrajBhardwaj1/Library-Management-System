<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Userviewprofile.aspx.cs" Inherits="Default3" %>
...
<div class = "container">
   ...
   <label>Pincode</label>
    ...
    <div class = "col-md-4">
   <label>Old Password</label><div class="form-group">
    ...
    <h4>Your Profile</h4>
        ...
        <asp:Label class="badge badge-pill  badge-info" ID="Label3" runat="server" Text="Your issued books"></asp:Label>
    </center>
    </div>
    </div>
   ...
   <hr />
      ...
      <div class = "row">
    <div class = "col">
        <asp:GridView class="table table-striped table-bordered" ID="GridView2" runat="server" OnRowDataBound="GridView2_RowDataBound">
        </asp:GridView>
    </div>
    </div>
