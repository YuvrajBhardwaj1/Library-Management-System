<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="UserLogin.aspx.cs" Inherits="Default3" %>
...
<div>
    ...
    <div class ="form-group">
        <asp:TextBox CssClass="form-control" ID="tbUsername" runat="server" placeholder="Member ID "></asp:TextBox>
    </div>
